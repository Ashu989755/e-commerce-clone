            ...
            <div className="lg:col-span-1 col-span-2">
              <div className="my_pro border shadow-md rounded-xl p-5 my-5">
                ...
                <div className="info_frm my-5">
                  ...
                  <div className="bg-[#F7F7F7] p-3 rounded-lg mb-4">
                    Lorem ipsum dolor sit amet consectetur. Nam metus egestas
                    eget id semper fermentum duis. Iaculis arcu sit integer
                    tristique porta hac et ut. Ullamcorper a facilisi faucibus a
                    sit in. Rhoncus aliquet cursus sed magna et tincidunt nulla
                    suspendisse id. Ante elit eu purus viverra velit maecenas
                    ullamcorper nunc varius. Pretium a amet consequat ac elit.
                    Posuere porttitor sagittis sit semper est duis scelerisque.
                  </div>
...
export default Personal_editprofile;
