...
import { businessSendEstimates, businessSaveEstimateItems } from "../../apis/business/Profile";
...
console.log(customerDetails,"============")
  ...
  const handleSendEstimates = async (data) => {
    ...
    try {
      ...
      formData.append("EstimateType", 1);
      formData.append("EstimatePriceType", type);
  ...
  const handleSaveEstimateItems = async (id) => {
    ...
    try {
      const apiData = {
        ...
        customerName: customerDetails[0]?.firstName,
        firstName: customerDetails[0]?.firstName,
        lastName: customerDetails[0]?.lastName,
        customerContactNumber: customerDetails[0]?.phoneValue,
        customerCountryCode: "",
        address1: customerDetails[0]?.address?.Address1,
        address2: customerDetails[0]?.address?.Address2,
        zipcode: customerDetails[0]?.address?.zipCode,
        city: customerDetails[0]?.address?.City,
        state: customerDetails[0]?.address?.State,
        country: customerDetails[0]?.address?.Country,
  ...
  const handleRemoveCustomer = (index) => {
    setCustomerDetails((prevItems) => prevItems.filter((_, i) => i !== index));
  ...
  return (
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-2 gap-5">
              <div className="col-span-2 lg:col-span-1">
                ...
                <div className="border shadow-md rounded-lg p-5 bg-white my-6">
                ...
                <div className="col-span-1 mt-4">
                  <div className="col-sm-1 relative">
                    ...
                    <input
                      type="time"
                      className="w-full outline-0 bg-[#f3f1f1] mt-3 py-4 px-6 rounded-lg shadow-sm focus:shadow-md border border-transparent focus:border-text_dark"
                      {...register("startTime")}
                      // value={selectedTime}
                    ...
                    {priceType === 1 && (
                      <>
                        <input
                          type="time"
                          className="w-full outline-0 bg-[#f3f1f1] py-4 px-6 rounded-lg shadow-sm focus:shadow-md border border-transparent focus:border-text_dark"
                          {...register("endTime")}
                  ...
                  <div className="info_frm my-5">
                    {priceType == 1 ? (
                      <div className="col-sm-1 relative">
                        ...
                        <span class="absolute left-3 top-14 flex items-center"></span>
                        <input
                          name="totalHours"
                      ...
                      <div className="col-sm-1 relative">
                        ...
                        <span class="absolute left-3 top-14 flex items-center">
                          <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                        ...
                        <input
                          name="totalHours"
                          className="w-full outline-0 bg-[#f3f1f1] py-4 px-10 rounded-lg 
                          shadow-sm focus:shadow-md border border-transparent focus:border-text_dark mt-3 ps-10"
                          {...register("totalHours")}
                        />
                        {errors.totalHours && (
                          <p className="text-red-500">
                    ...
                    <div className="grid grid-row-2 gap-4 mt-9">
                      <div className="col-sm-1 relative">
                        ...
                        <input
                          type="text"
                          className="w-full outline-0 bg-[#f3f1f1] py-4 px-10 rounded-lg  mt-3
                      ...
                      <div className="col-sm-1 relative">
                        ...
                        <span className="absolute left-3 top-14 flex items-center"></span>
    ...
    shadow-sm focus:shadow-md border border-transparent focus:border-text_dark"
                      ...
                      <div className="col-sm-1 relative">
                        ...
                        <select
                          id="inputState"
                          class="form-select w-full outline-0 bg-[#f3f1f1] py-4 px-10 rounded-lg mt-3
                          shadow-sm focus:shadow-md border border-transparent focus:border-text_dark"
                      ...
                      {customerDetails.length > 0 ? (
                        <div className="customer-list">
                          <h2 className="text-gray-800 p-2">Customer Detail</h2>
                              ...
                              <div className="flex items-center ml-4">
                                ...
                                >
                                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M2 21.5V17.5L14.12 5.38L18.12 9.38L6 21.5H2Z" fill="#000" />
                                    <path d="M20.71 7.04L16.71 3.04L18.83 0.91C19.22 0.52 19.82 0.52 20.21 0.91L23.09 3.79C23.48 4.18 23.48 4.78 23.09 5.17L20.71 7.04Z" fill="#000" />
                                  </svg>
                        ...
                        <button
                          ...
                          className="bg-white py-4 px-10 text-dark_link border border-dark_link font-medium rounded-lg"
                        >
                          Add Customer Manually
                        </button>
                      )}

                      <div className="inp mb-4  gap-3">
