...
function SendEstimatesContract() {
  const {
    register,
    control,
    reset,
...
console.log(errors,"=================")
  ...
  const handleSendEstimates = async (data) => {
    ...
    console.log("Job Opening Date:", jobOpeningDate);
    console.log("Job Closing Date:", jobClosingDate);
...
export default SendEstimatesContract;
