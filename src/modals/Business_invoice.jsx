...
function Business_invoice({ isOpen, closeModal, estimateList }) {
  ...
  const handleHourlyClick = () => {
    navigate("/send-invoice", { state: { estimateList, type: 0 } });
  };

  const handleFixedClick = () => {
    navigate("/send-invoice", { state: { estimateList, type: 1} }); 
  };
