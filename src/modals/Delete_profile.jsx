...
import { businessDeleteUser } from '../apis/business/Profile'

function Delete_profile({isOpen,closeModal, userId}) {
...
const handleDeleteUser = async() => {
  try {
    ...
    const res = await businessDeleteUser(apiData)
    closeModal()
