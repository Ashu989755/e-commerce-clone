...
function   GiveRating ({ isOpen, closeModal, id }) {
    const {
      register,
      handleSubmit,
      formState: { errors },
    ...
    // Dynamically update color based on rating value
    const getColor = () => {
      if (rating <= 3) return "#ff4e50"; // red for low rating
      if (rating <= 5) return "#f9d423"; // yellow for mid rating
      if (rating <= 7) return "#24c6dc"; // blue for higher rating
      return "#30d94b"; // green for best rating
    };
  ...
  const res = await businessAddReview(apiData)
            ...
            <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block ">
              ...
              >
                ...
                <div className="bg-white ">
                  <div className="">
                    <div className="mt-3 py-5 px-5  sm:mt-0 sm:text-left">
                      <div className="relative">
                        <h3 className="text-lg font-semibold text-center">Give Rating</h3>
                        ...
                        <div className="inp my-4 relative">
                          ...
                          <div className="flex gap-3 items-center">
                            <input
                              className="w-full text-sm outline-0 bg-[#F7F7F7] p-4 rounded-lg shadow-sm focus:shadow-md border border-transparent focus:border-text_dark"
                              placeholder="DD"
                              type="date"
                              name=""
                              id=""
